...
| `page update` | 업데이트된 페이지 전체 반환 (version 포함) | ~200-400 | `12345678 updated v3 (OK)` ~12 | **높음** |
...
```
total: 23 (showing 3)
RLM-3 | Epic | To Do | Medium | 검색 결과 정렬 개선 | @seungmok.song | 2026-04-10
RLM-24 | Story | To Do | Medium | Multi-Source 실차 성능 향상... | @eunsan.jo | 2026-04-10
RLM-23 | Story | To Do | Medium | 리포트 빌드 인프라 | @eunsan.jo | 2026-04-10
```
...
**MCP 호출**: `confluence_get_page(page_id="12345678")`

#### atls compact 설계안
```
12345678 | [RLM-3] 검색 결과 정렬 개선 | IVSL | v2
---
...
```
total: 3
12345001 | [RLM-23] 리포트 빌드 인프라 | IVSL
12345002 | [RLM-20] 사용자 검색 쿼리 빌더 구현 | IVSL
12345003 | [RLM-22] 캐시 데이터셋 재빌드 + 디스크 용량 산정 | IVSL
```
...
| `tests/fixtures/confluence/get-page-12345678.json` | `confluence_get_page` | md 변환 |
| `tests/fixtures/confluence/get-page-12345678-raw.json` | `confluence_get_page` | storage XHTML |
